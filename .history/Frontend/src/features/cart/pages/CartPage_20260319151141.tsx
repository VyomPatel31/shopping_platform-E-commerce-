...
const CartPage: React.FC = () => {
  const { items, fetchCart, updateQuantity: storeUpdateQuantity, removeItem: storeRemoveItem, isLoading, error } = useCartStore();
                  ...
                  <div className="flex-1 flex flex-col justify-between h-full text-center sm:text-left">
                    ...
                    <div className="mt-4 flex flex-col sm:flex-row items-center sm:justify-between space-y-4 sm:space-y-0">
                      <div className="flex items-center space-x-4">
                        <div className="flex items-center bg-white/5 border border-white/10 rounded-xl overflow-hidden shadow-inner">
                          <button
                            ...
                            className="p-2 hover:bg-white/10 text-gray-400 hover:text-white transition-colors disabled:opacity-50"
                            disabled={isLoading}
                          >
                      ...
                      <button
                        ...
                        className="text-gray-500 hover:text-red-500 transition-colors flex items-center space-x-1 disabled:opacity-50"
                        disabled={isLoading}
                      >
